export const messages = {
  header: {
    title: "Baggy's Data Enrichment Framework",
    subtitle:
      "Supercharge your datasets with AI-powered enrichment using Perplexity. Upload your data and let our intelligent system fill in the missing pieces.",
    features: {
  ...
  customInstructions: {
    ...
    placeholder:
      "E.g., 'Focus on finding the most recent professional information. Prioritize corporate email addresses over personal ones. Look for official business addresses when available.'",
    helpText:
    ...
    examples: {
      ...
      recent: {
        ...
        instruction:
          "Please prioritize finding the most recent and up-to-date information available, especially for professional details and contact information.",
      },
      business: {
        title: "Business Context",
        instruction:
          "Focus on business-related information and professional contexts. Look for corporate email addresses and official business addresses when available.",
      },
      region: {
        title: "Specific Region",
        instruction:
          "Please focus on information from the United States and use US address formats. Prioritize US-based companies and contact details.",
      },
    },
    useButton: "Use This",
    tips: {
  ...
  apiConfiguration: {
    ...
    description:
      "Enter your Perplexity API key to enable data enrichment. Your key is stored locally and never sent to our servers.",
  ...
  enrichmentControls: {
    title: "Enrichment",
    description:
      "Start the AI-powered data enrichment process to fill in missing information.",
    status: {
      ready: {
  ...
  columnConfiguration: {
    ...
    description:
      "Define the data fields you want to enrich. Each column needs a name and abbreviation for the AI response format.",
    emptyState: {
